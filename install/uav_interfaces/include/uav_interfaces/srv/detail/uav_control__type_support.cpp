...
{
  new (message_memory) uav_interfaces::srv::UavControl_Request(_init);
}

void UavControl_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<uav_interfaces::srv::UavControl_Request *>(message_memory);
  typed_message->~UavControl_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember UavControl_Request_message_member_array[4] = {
  {
    "takeoff_land",  // name
    ...
    offsetof(uav_interfaces::srv::UavControl_Request, takeoff_land),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uav_interfaces::srv::UavControl_Request, x_deta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uav_interfaces::srv::UavControl_Request, y_deta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uav_interfaces::srv::UavControl_Request, z_deta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UavControl_Request_message_members = {
  "uav_interfaces::srv",  // message namespace
  "UavControl_Request",  // message name
  4,  // number of fields
  sizeof(uav_interfaces::srv::UavControl_Request),
...
{
  return &::uav_interfaces::srv::rosidl_typesupport_introspection_cpp::UavControl_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uav_interfaces, srv, UavControl_Request)() {
  return &::uav_interfaces::srv::rosidl_typesupport_introspection_cpp::UavControl_Request_message_type_support_handle;
}
...
void UavControl_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) uav_interfaces::srv::UavControl_Response(_init);
}

void UavControl_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<uav_interfaces::srv::UavControl_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UavControl_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uav_interfaces::srv::UavControl_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UavControl_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(uav_interfaces::srv::UavControl_Response),
...
{
  return &::uav_interfaces::srv::rosidl_typesupport_introspection_cpp::UavControl_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uav_interfaces, srv, UavControl_Response)() {
  return &::uav_interfaces::srv::rosidl_typesupport_introspection_cpp::UavControl_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers UavControl_service_members = {
  "uav_interfaces::srv",  // service namespace
  "UavControl",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<uav_interfaces::srv::UavControl>()
...
get_service_type_support_handle<uav_interfaces::srv::UavControl>()
{
  ...
  auto service_type_support =
    &::uav_interfaces::srv::rosidl_typesupport_introspection_cpp::UavControl_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uav_interfaces, srv, UavControl)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<uav_interfaces::srv::UavControl>();
}
